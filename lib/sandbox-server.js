...
module.exports = function(program) {
	...
	// If liveReload is true, configure the middleware
	if (program.liveReload) {
		localhost.use(tinylr.middleware({
			app: localhost,
			liveCSS: true,
			liveJs: true,
			liveImg: true
	...
	// Render the trust cert page over http
	localhost.get('/trustcert', function(req, res, next) {
